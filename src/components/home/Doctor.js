          ...
          <div className="col-md-12 request-form">
            <form onSubmit={this.submitRequest.bind(this)}>
              <TextField
                ...
                required
              />
              <RaisedButton type="submit" label="Request Medical Records" primary={true} className="width-100"/>
            </form>
          </div>
                  ...
                  {this.state.requests.map((request, index)=>{
                      return (
                          <TableRow key={index}>
                            ...
                            <TableRowColumn>
                                  <RaisedButton onClick={this.changeRoute.bind(this, `/home/records/${request.requested_to}`)} disabled={request.status === 'pending' || request.status === 'rejected'} label="View Medical Records" Primary={true}/>
                            </TableRowColumn>
                          </TableRow>
                      )
                  })}
